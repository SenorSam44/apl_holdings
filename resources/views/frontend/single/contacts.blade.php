        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <form method="post" class="form-row mt-5" action="{{URL::to('/messages')}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="col-lg-6">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <ul class="contact-info">
                        ...
                        <li class="contact-info-item email">
                            ...
                            <p><a href="mailto:info@samplemail.com">aplholdings@gmail.com</a></p>
                            <p><a href="mailto:support@samplemail.com">aplholdings@gmail.com</a></p>
                        </li>
