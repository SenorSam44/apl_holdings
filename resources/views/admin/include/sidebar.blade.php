<div class="sidebar-nav navbar-collapse">
    <ul class="nav" id="side-menu">
        ...
        <li>
            <a href="#"><i class="fa fa-map fa-fw"></i>  Office Locations <span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
                <li>
                    <a href="{{route('office-location.create')}}">Add Office Location</a>
                </li>
                <li>
                    <a href="{{route('office-location.index')}}">Manage  Office Locations</a>
                </li>
            </ul>
        </li>
